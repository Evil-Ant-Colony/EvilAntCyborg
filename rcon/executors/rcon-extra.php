...
/**
 * \brief Show the IRC channel to player when they say !irc
 * \note Install before Rcon2Irc_Say
 */
class Rcon2Irc_ShowIRC extends Rcon2Irc_Executor
{
	function __construct($trigger='!irc')
	{
		parent::__construct("{^\1(.*?)\^7:\s*$trigger$}");
	}
